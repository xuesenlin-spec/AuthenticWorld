...
os.environ["OPENAI_API_KEY"] = "sk-5b4bb958a3e44bda85b5cbcc5e96d2ca"
os.environ["OPENAI_BASE_URL"] = "https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions"
...
from android_world.agents import pega_agent
...
_SUITE_FAMILY = flags.DEFINE_enum(
    ...
    [
        ...
        # Pega: long-horizon cross-app tasks.
        registry.TaskRegistry.PEGA_FAMILY,
    ],
